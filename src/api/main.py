...
from src.api.routers import health, routes, stops, metrics, realtime, marta_realtime
from src.api.websocket import websocket_endpoint, manager
from src.api import ml_endpoints
...
app.include_router(marta_realtime.router, prefix=f"{settings.api_prefix}/marta", tags=["marta"])
app.include_router(ml_endpoints.router, tags=["Machine Learning"])
